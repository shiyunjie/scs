...
public class RSAUtils {
   ...
   /* public static void main(String[] args) throws Exception {
        ...
        byte[] encodedData = RSAUtils.encryptByPublicKey(content.getBytes(), publicKey);
        String baseEnData= Base64Util.encode(encodedData);
        System.out.println("加密后文字：\r\n" + baseEnData);
        byte[] decodedData = RSAUtils.decryptByPrivateKey(Base64Util.decode(baseEnData), privateKey);
